...
<?php
	...
	if(!$conn){
		...
		$sql="SELECT* FROM BLOG WHERE TECHNOLOGY='Machine learning '";
...
<html>
<head>
	<title>Machinelearning_Blogs</title>
	<style >
		body{
			width: 100%;
			height:100vh;
			background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(images/ml.jpg);
